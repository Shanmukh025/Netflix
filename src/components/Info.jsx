...
const Info = () => {
    ...
    <div className='infoheading'>
        ...
        <div className='infoboxes'>
            ...
            <br/>
            <h2>Basic</h2><br/>
                <p>A great way to enjoy all your favourite shows and movies on a budget.</p><br/>
                <h3>₹199/month</h3>
            </div>
            <div className='box'>
    ...
    <br/>
    <p>
    <ul><li>Unlimited access to more than 50+ exclusive mobile games.</li>
    <li>Download on Android phones, tablets, iPhone, iPads and Laptops.</li>
    <li>Download on Android phones, tablets, iPhone, iPads.</li></ul>
    </p>
    </div>
    </div>
    <div className='infoheading'>
